/* =====================================================================
   CSEG3060 - Research Methodology in Computer Science : shared behaviour for the notes
...
(function () {
    ...
    try {
        var saved = localStorage.getItem('rm-notes-theme');
    ...
    document.addEventListener('click', function (ev) {
        ...
        if (a === 'theme') {
            ...
            try { localStorage.setItem('rm-notes-theme', next); } catch (e) { }
        } else if (a === 'print') {
            window.print();
        }
    });
